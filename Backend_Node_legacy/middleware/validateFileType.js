...
async function validateBufferMagicNumber(buffer, allowedMimes) {
    try {
        ...
        return !!(result && allowedMimes.has(result.mime));
    } catch {
        return false;
    }
}
...
module.exports = { validateMagicNumber, validateFiles, validateBufferMagicNumber, ALLOWED_IMAGE_MIMES, ALLOWED_DOCUMENT_MIMES };
